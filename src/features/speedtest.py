...
class SpeedTester():
    ...
    def speed_check(self):
        ...
        try:
            ...
            print(f"Download speed  : {download_speed_in_mb} mpbs\nUpload speed : {upload_speed_in_mb} mpbs\nPing : {ping_in_ms} ms")

            speedtest_result = f"Download speed is {download_speed_in_mb} megabytes per second. Upload speed is {upload_speed_in_mb} megabytes per second. Ping is {ping_in_ms} milliseconds."
