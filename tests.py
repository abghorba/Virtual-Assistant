...
class TestYahooFinanceScraper:
    ...
    @pytest.mark.parametrize(
        "query,expected",
        [
            ("stock price of Tesla", "The stock price is $1,229.91 per share."),
            ("stock price of Costco", "The stock price is $515.62 per share."),
            ("stock price of Apple", "The stock price is $150.96 per share."),
            ("", "Parameter 'query' cannot be blank."),
        ],
    )
